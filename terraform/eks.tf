...
resource "aws_eks_cluster" "main" {
  ...
  vpc_config {
    ...
    public_access_cidrs     = var.cluster_endpoint_public_access ? (length(var.cluster_endpoint_public_access_cidrs) > 0 ? var.cluster_endpoint_public_access_cidrs : ["51.20.142.84/32"]) : null
  }
...
# ==============================================================================
# 5. EKS OIDC Provider (for IAM Roles for Service Accounts - IRSA)
# ==============================================================================
